...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-primary">
                  ...
                  <div class="box-body">
                    <div class="debug"></div>
                        <form class="form-horizontal" id="input_excels" action="<?=base_admin();?>modul/excel/input_page.php" method="post" target="_blank">
...
$("#input_excel").submit(function(e) {
  ...
  function fetch_table(val)
  {
    if (val!='') {
         $.ajax({
      url: "<?=base_admin();?>modul/excel/get_table.php?tb="+val,
      success:function(data){
      //  alert(data);
        $("#isi_table").html(data);
      }
      ...
      $.ajax({
        url: "<?=base_admin();?>modul/excel/for_view.php?tb="+val,
        success:function(data){
        //  alert(data);
          $("#isi_view").html(data);
        }
...
function id_generator() {
  ...
  function isi_kanan(val,prev_tb)
  {
    ...
    $.ajax({
     ...
     $.ajax({
      //?tb="+tb+"&col="+col
      url: "<?=base_admin();?>modul/excel/embed_list.php?tb="+val,
      success:function(data){
