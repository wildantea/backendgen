...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-primary">
                  ...
                  <div class="box-body">
                        <form class="form-horizontal" id="inputss" action="<?=base_admin();?>modul/page/input_page.php" method="post">
                    ...
                    <div class="form-group" id="show_icon">
                        ...
                        <a target="_blank" href="<?=base_index();?>page/icon">Icon Reference (new window)</a>
                        </div>
                      </div><!-- /.form-group -->
                             <div class="form-group">
                 <label class="control-label col-lg-2"><?=$lang['menu_type'];?></label>
                 <div class="col-lg-10">
                   <select data-placeholder="Pilih Modul" name="type_menu" onChange="type_of_menu(this.value)" class="form-control chzn-select" tabindex="2">
                     ...
                     <option value="separator">Menu Separator</option>
                     <option value="page">Page</option>
                   </select>
                 </div>
              </div>

                    <div class="form-group" id="after_menu" style="display: none">
                        <label class="control-label col-lg-2">Position After</label>
                        <div class="col-lg-10">
                          <select data-placeholder="Select Postion Menu" name="position" class="form-control chzn-select" tabindex="2">
                            <?php foreach ($db->query('select * from sys_menu where parent=0') as $isi) {
                     ...
                     <div id="type_menu" style="display:none">
                         <div class="form-group">
                        <label class="control-label col-lg-2"><?=$lang['crud_method'];?></label>
                        <div class="col-lg-10">
                        <select class="form-control" onChange="list_type(this.value)" id="method_table" name="method_table">
                         <option value="">Select Method</option>
                          <option value="dtb_server">Datatable Server Side</option>
                          <option value="dtb_manual">Datatable Local</option>
                          <option value="manual_pagination">Custom Pagination</option>
                          <option value="gallery">Create Album Gallery </option>
                        </select>
                        </div>
                      </div>

                      </div>
                      <div id="crud_style" style="display:none">
                         <div class="form-group">
                        <label class="control-label col-lg-2"><?=$lang['crud_style'];?></label>
                        <div class="col-lg-10">
                        <select class="form-control" name="crud_style">
...
//type menu
  ...
  function fetch_table(val)
  {
    if (val!='') {
         $.ajax({
      url: "<?=base_admin();?>modul/page/get_table.php?tb="+val,
      ...
      $.ajax({
        url: "<?=base_admin();?>modul/page/for_view.php?tb="+val,
        success:function(data){
        //  alert(data);
          $("#isi_view").html(data);
        }
...
function id_generator() {
  ...
  function tipe(val,col)
  {
    ...
    if (val=='select') {
        $.ajax({
      url: "<?=base_admin();?>modul/page/isi_from_table.php?col="+col,
      success:function(data){
  ...
  function from_table(tb,col)
  {
    if (tb!='') {
            $.ajax({
      url: "<?=base_admin();?>modul/page/isi_on.php?tb="+tb+"&col="+col,
      success:function(data){
  ...
  function show_primary_chain(tb,col)
  {
      ...
      //foreign from checkbox
            $.ajax({
      url: "<?=base_admin();?>modul/page/isi_chain_primary.php?tb="+tb+"&col="+col,
      success:function(data){
        ...
        $("#primary_chain_"+col).html(data);
         $("#parent_data_"+col).html('');
                    ...
                    $.ajax({
      url: "<?=base_admin();?>modul/page/isi_chain_label_first.php?tb="+tb+"&col="+col,
      success:function(data){
      ...
      $.ajax({
      url: "<?=base_admin();?>modul/page/isi_chain_foreign_first.php?tb="+tb+"&col="+col,
      success:function(data){
  ...
  function show_primary_chain_parent(tb,col,rand,rand2,rand3)
  {
      ...
      //foreign from checkbox
            $.ajax({
      url: "<?=base_admin();?>modul/page/isi_chain_primary_parent.php?tb="+tb+"&col="+col+"&rand_id="+rand,
      success:function(data){
        ...
        $.ajax({
      url: "<?=base_admin();?>modul/page/isi_chain_foreign_parent.php?tb="+tb+"&col="+col+"&rand_id="+rand,
      success:function(data){
  ...
  function foreign_table_checkbox(tb,col)
  {
      ...
      //foreign from checkbox
            $.ajax({
      url: "<?=base_admin();?>modul/page/foreign_table_checkbox.php?tb="+tb+"&col="+col,
      success:function(data){
      ...
      //foreign main table
      $.ajax({
      url: "<?=base_admin();?>modul/page/foreign_table_checkbox_main.php?tb="+tb+"&col="+col,
      success:function(data){
    ...
    function from_table_radio(tb,col)
  {
    if (tb!='') {
            $.ajax({
      url: "<?=base_admin();?>modul/page/isi_label_for_radio.php?tb="+tb+"&col="+col,
      success:function(data){
    ...
    function from_table_checkbox(tb,col)
  {
    if (tb!='') {
            $.ajax({
      url: "<?=base_admin();?>modul/page/isi_label_for_checkbox.php?tb="+tb+"&col="+col,
      success:function(data){
    ...
    function from_table_checkbox_normal(tb,col)
  {
    if (tb!='') {
       var maintb = $('#main_table').find(":selected").text();
            $.ajax({
      url: "<?=base_admin();?>modul/page/isi_label_for_checkbox_normal.php?tb="+tb+"&col="+col+"&maintb="+maintb,
      success:function(data){
  ...
  function add_join()
  {
    var tb = $('#main_table').find(":selected").text();
     $.ajax({
      ...
      //?tb="+tb+"&col="+col
      url: "<?=base_admin();?>modul/page/isi_join.php?prev_tb="+tb,
      success:function(data){
  ...
  function isi_kanan(val,prev_tb)
  {
    ...
    $.ajax({
      //?tb="+tb+"&col="+col
      url: "<?=base_admin();?>modul/page/isi_kanan_join.php?tb="+val+"&prev="+prev_tb,
      success:function(data){
     ...
     $.ajax({
      //?tb="+tb+"&col="+col
      url: "<?=base_admin();?>modul/page/embed_list.php?tb="+val,
      success:function(data){
  ...
  function add_join_with(prev)
  {
     $.ajax({
      ...
      //?tb="+tb+"&col="+col
      url: "<?=base_admin();?>modul/page/isi_join_with.php?prev_tb="+prev,
      success:function(data){
  ...
  function add_multi_image()
  {
     var tb = $('#main_table').find(":selected").text();
    $.ajax({
      url: "<?=base_admin();?>modul/page/isi_multi_image.php?prev_tb="+tb,
      success:function(data){
 ...
 //   alert(col);
     // console.log('yes');
      ...
      $("#radio_box_type_"+col).html("<div class='form-group'> <div class='row' style='margin-left: 0;'> <div class='col-lg-4' style='padding-top:2px;margin-left:15px'> <input type='text' id='required' name='radio_custom_value["+col+"][]' placeholder='Value' class='form-control'> </div> <div class='col-lg-6' style='padding-left:0;padding-top:2px'> <input type='text' id='required' name='radio_custom_label["+col+"][]' placeholder='Item/Label Name' class='form-control'> </div> <div class='col-lg-1' style='padding-left:0;padding-top:6.5px'> <span onclick=\"add_new_row_radio('"+col+"')\" class='btn btn-block btn-info btn-xs'><i class='fa fa-plus' style='padding: 5px'></i></span> </div> </div> <span id='add_next_row_radio_"+col+"'></span> </div>");
                  ...
                  $.ajax({
                  url: "<?=base_admin();?>modul/page/isi_from_table_radio.php?col="+col,
                  success:function(data){
 ...
 //   alert(col);
     // console.log('yes');
      if (value=='custom_checkbox') {
          $("#check_box_type_"+col).html("<div class='form-group'> <div class='row' style='margin-left: 0;'> <div class='col-lg-9' style='padding-top:2px;margin-left: 15px;'> <input type='text' id='required' name='checkbox_custom_display["+col+"][]' placeholder='Display Item' class='form-control'> </div> <div class='col-lg-1' style='padding-left:0;padding-top:5.5px;width:50px'> <span onclick=\"add_new_row_checkbox('"+col+"')\" class='btn btn-block btn-info btn-xs'><i class='fa fa-plus' style='padding: 6px'></i></span> </div> </div><span id='add_new_row_checkbox"+col+"'></span> <span id='add_next_row_checkbox_"+col+"'></span> </div>");
                  ...
                  $.ajax({
                  url: "<?=base_admin();?>modul/page/isi_from_table_checkbox.php?col="+col,
                  success:function(data){
             ...
             $.ajax({
              url: "<?=base_admin();?>modul/page/isi_from_table_checkbox_normal.php?col="+col,
              success:function(data){
                    $("#check_box_type_"+col).html(data);
                 }
              });
  ...
  {
      $.ajax({
      url: "<?=base_admin();?>modul/page/isi_chain_parent.php?col="+col,
      success:function(data){
  ...
  {
     $.ajax({
      url: "<?=base_admin();?>modul/page/isi_foreign_album.php?table="+key,
      success:function(data){
  ...
  function get_album(key)
  {
     ...
     $.ajax({
      url: "<?=base_admin();?>modul/page/isi_create_album.php?table="+key,
      success:function(data){
        $("#isi_album").html(data);
        }
      });
  ...
  function change_key(key)
  {
     ...
     $.ajax({
      url: "<?=base_admin();?>modul/page/isi_remote_key.php?table="+key,
      success:function(data){
