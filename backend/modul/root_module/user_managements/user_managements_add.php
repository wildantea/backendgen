      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          ...
          <span class="isi_warning"></span>
            ...
            <form id="input_user_managements" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/root_module/user_managements/user_managements_action.php?act=in">
