                      ...
                      <div class="box-body">
                       <div class="alert alert-danger error_data" style="display:none">
                        ...
                        <span class="isi_warning"></span>
                          ...
                          <form id="edit_user_managements" method="post" class="form-horizontal" action="<?=base_admin();?>modul/root_module/user_managements/user_managements_action.php?act=up">
