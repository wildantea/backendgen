...
<html>
  <head>
    ...
    <title>Ruangan Rest API Documentation</title>
  ...
  <body class="skin-blue fixed" data-spy="scroll" data-target="#scrollspy">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a style="font-size: 13px;" href="<?=base_url();?>api/ruangan/doc" class="logo"><b>Ruangan Restful API</b></a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar" id="scrollspy">
          ...
          <ul class="nav sidebar-menu">
            ...
            <li><a href="#list_user"><i class='fa fa-circle-o'></i> GET /api/ruangan</a></li>
            <li><a href="#detail_user"><i class='fa fa-circle-o'></i> GET /api/ruangan/:id</a></li>
            <li><a href="#search"><i class='fa fa-circle-o'></i> GET /api/ruangan/search/:search keyword</a></li>
            <li><a href="#token"><i class='fa fa-circle-o'></i> Key Token</a></li>
            <li><a href="#post_user"><i class='fa fa-circle-o'></i> POST /api/ruangan</a></li>
            <li><a href="#update"><i class='fa fa-circle-o'></i> PUT /api/ruangan/update/:id</a></li>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <h1>
            Ruangan Rest API Documentation
...
<section id='overview'>
  ...
  <p class='lead'>
    This is auto-generated document for <b>ruangan Rest API</b> that you can use to query ruangan data, search ruangan, update ruangan, and delete ruangan data.
  </p>
...
<section id="method">
  ...
  <p class="lead"></p>
    ...
    <td><?=base_url();?>api/ruangan</td>
    <td>Retrieve all ruangan</td>
    </tr>
     <tr class="row-even"><td>GET</td>
    <td><?=base_url();?>api/ruangan/1</td>
    <td>Retrieve single ruangan based on primary key</td>
    </tr>
    <tr class="row-odd"><td>GET</td>
    <td><?=base_url();?>api/ruangan/search/search keyword</td>
    <td>Search for ruangan with keyword 'search keyword’</td>
    </tr>
    <tr class="row-odd"><td>POST</td>
    <td><?=base_url();?>api/ruangan</td>
    <td>Add or post new ruangan</td>
    </tr>
    <tr class="row-even"><td>PUT</td>
    <td><?=base_url();?>api/ruangan/update/1</td>
    <td>Update ruangan data</td>
    </tr>
    <tr class="row-odd"><td>DELETE</td>
    <td><?=base_url();?>api/ruangan/delete/1</td>
    <td>Delete ruangan data based on primary key</td>
    </tr>
    </tbody>
    </table>
    </div>
...
<section id='list_user'>
  <h2 class='page-header'><a href="#list_user">GET /api/ruangan</a></h2>
  <p class='lead'>
    Return all ruangan data. By default Json response will show 10 data per page, but you can add 'perpage' parameter on url to show less or more than 10 data. and alswo to show the next 10 records, you can add 'page' parameter on url<br>
  </p>
<h3>Resource URL</h3>
<h4><?=base_url();?>api/ruangan</h4>
Go to page 3 by adding 'page' parameter  
<h4><?=base_url();?>api/ruangan?page=3</h4>
Go to page 3 and show 15 data with 'perpage' parameter
<h4><?=base_url();?>api/ruangan?page=3&perpage=15</h4>
...
{  
   ...
   paginations:{  
      self:"<?=base_url();?>api/ruangan?page=1&perpage=3",
      first:"<?=base_url();?>api/ruangan?page=1&perpage=3",
      prev:"<?=base_url();?>api/ruangan?page=1&perpage=3",
      next:"<?=base_url();?>api/ruangan?page=2&perpage=3",
      last:"<?=base_url();?>api/ruangan?page=172&perpage=3"
   }
}
</pre>
<ul>
...
<section id="detail_user">
  <h2 class="page-header"><a href="#detail_user">GET /api/ruangan/:id</a></h2>
  <p class="lead">Show Detail Single ruangan</p>

<h3>Resource URL</h3>
<h4><?=base_url();?>api/ruangan/:id</h4>
<h3>Example Result</h3>
<h4><?=base_url();?>api/ruangan/107</h4>
    <pre class="prettyprint">
    {
    status: {
        code: 200,
...
<section id="search">
  <h2 class="page-header"><a href="#search">GET /api/ruangan/search/:search keyword</a></h2>
  <p class="lead">Returns a collection of relevant ruangan matching a specified query.</p>

<h3>Resource URL</h3>
<h4><?=base_url();?>api/ruangan/search/:search keyword</h4>
<h3>Example Result</h3>
<h4><?=base_url();?>api/ruangan/search/search keyword</h4>
    <pre class="prettyprint">
{
    ...
    paginations: {
        self: "<?=base_url();?>api/ruangan/search/search keyword?page=1",
        first: "<?=base_url();?>api/ruangan/search/search keyword?page=1",
        prev: "<?=base_url();?>api/ruangan/search/search keyword?page=1",
        next: "<?=base_url();?>api/ruangan/search/search keyword?page=1",
        last: "<?=base_url();?>api/ruangan/search/search keyword?page=1"
    }
}s
</pre>
Response structure is equal to get ruangan
</section>
...
<h3>Resource URL</h3>
<h4><?=base_url();?>api/ruangan/login</h4>
<h3>Parameters</h3>
...
<section id='post_user'>
  <h2 class='page-header'><a href="#post_user">POST /api/ruangan</a></h2>
  <p class='lead'>
    Create / Post New ruangan<br>
  </p>
<h3>Resource URL</h3>
<h4><?=base_url();?>api/ruangan</h4>
<h3>Parameters</h3>
...
<section id='update'>
  <h2 class='page-header'><a href="#update">PUT /api/ruangan/update/:id</a></h2>
  <p class='lead'>
    Use PUT method to Update ruangan data. The request parameter structure is just like previous the <a href='#post_user'>post data</a> <br>
  </p>
<h3>Resource URL</h3>
<h4><?=base_url();?>api/ruangan/update/:id</h4>
<h3>Sample URL</h3>
<h4><?=base_url();?>api/ruangan/update/107</h4>
...
<section id='delete'>
  <h2 class='page-header'><a href="#delete">DELETE /api/ruangan/delete/:id</a></h2>
  <p class='lead'>
    Delete ruangan Data <br>
  </p>
<h3>Resource URL</h3>
<h4><?=base_url();?>api/ruangan/delete/:id</h4>

Add header request with token value if you previously enable the authentication, otherwise just send the request.
<h3>Example Result</h3>
<h4><?=base_url();?>api/ruangan/delete/107</h4>
